...
namespace StringORM
{
    public class Tests
    {
        ...
        {
            SqlDataReader reader = "SELECT * FROM dbo.Names where Name = @Name".GetDataReader(new SqlParameter("@Name", "SomeNameWithId"));
            reader.Should().NotBeNull();
        }
        [Fact]
        public void get_reader_isnt_null_with_parameter_with_specific_connection()
        {
            SqlDataReader reader = "SELECT * FROM dbo.Names where Name = @Name".GetDataReader(DataBase.Default, new SqlParameter("@Name", "SomeNameWithId"));
            reader.Should().NotBeNull();
        }
        [Fact]
        ...
        public void get_reader_isnt_null_with_list_of_parameters_with_specific_connection()
        {
            ...
            SqlDataReader reader = "SELECT * FROM dbo.Names where Name = @Name AND Id = @Id".GetDataReader(DataBase.Default, sqlParameters);
            reader.Should().NotBeNull();
        }
        #endregion
        ...
        {
            DataTable table = "SELECT * FROM dbo.Names where Name = @Name".GetDataTable(new SqlParameter("@Name", "SomeParamName"));
            table.Should().NotBeNull();
        }
        [Fact]
        public void get_data_table_isnt_null_with_parameter_with_specific_connection()
        {
            DataTable table = "SELECT * FROM dbo.Names where Name = @Name".GetDataTable(DataBase.Default, new SqlParameter("@Name", "SomeParamName"));
            table.Should().NotBeNull();
        }
        [Fact]
        ...
        {
            object scalar = "SELECT * FROM dbo.Names where Name = @Name".GetScalar(new SqlParameter("@Name", "SomeParamName"));
            scalar.Should().NotBeNull();
        }
        [Fact]
        public void get_scalar_isnt_null_with_parameter_with_specific_connection()
        {
            object scalar = "SELECT * FROM dbo.Names where Name = @Name".GetScalar(DataBase.Default, new SqlParameter("@Name", "SomeParamName"));
            scalar.Should().NotBeNull();
        }
        [Fact]
        ...
        public void get_scalar_isnt_null_with_list_of_parameters_with_specific_connection()
        {
            ...
            object scalar = "SELECT * FROM dbo.Names where Name = @Name and Id = @Id".GetScalar(DataBase.Default, sqlParameters);
            scalar.Should().NotBeNull();
        }
        #endregion
        ...
        {
            "INSERT INTO Names (Name) VALUES (@Name)".Execute(DataBase.Default, new SqlParameter("@Name", "SomeParamName"));
        }
        [Fact]
